...
import '../modules/notifications/screens/notifications_page.dart';
import '../modules/profile/profile_page.dart';
import '../modules/settings/settings_page.dart';
import '../modules/start/presentation/start_page.dart';
import '../modules/wallet/screens/create_wallet_page.dart';
...
Map<String, WidgetBuilder> getRoutes(BuildContext context) => {
      ...
      '/start/wallet/create_wallet': (context) => CreateWalletPage(),
    };
